...
const siteConfig = {
  ...
  headerLinks: [
    ...
    {href: 'https://github.com/mozilla/ecosystem-platform', label: 'GitHub'}
  ],

  // If you have users set above, you add it here:

  /* path to images for header/footer */
  headerIcon: 'img/fx-master-brand.png',
  footerIcon: 'img/fx-master-brand.png',
  favicon: 'img/fx-master-brand.png',

  /* Colors for website */
  colors: {
    primaryColor: 'rgba(32, 18, 58, 1)',
    secondaryColor: 'rgba(32, 18, 58, 1)',
  },
