...
:::warning
`yarn start` starts up **all** required services via PM2. This includes Redis, MySQL, and Memcached. It is recommended that you don't run these services yourself, or occupy any of the server ports (check out our [PM2 configs](https://github.com/search?type=code&q=repo%3Amozilla%2Ffxa+%28path%3A**%2Fpm2.config.js+OR+path%3A**%2Finfrastructure.config.js%29)). Doing so may result in errors.
:::
:::tip
