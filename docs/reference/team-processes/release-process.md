...
1. Watch the output of the action to make sure everything goes correctly but you should be all done!  Once the code is tagged and the docker containers are built you'll see messages in slack as it auto-deploys to our staging server.
