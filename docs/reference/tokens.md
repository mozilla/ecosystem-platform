...
Session tokens are an **_FxA Hawk Token_** where the 32-byte string is generated by the server. They can be obtained by:
...
A special-use **_Hawk token_** for changing password.
